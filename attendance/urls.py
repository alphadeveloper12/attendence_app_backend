...
web_urlpatterns = [
    ...
    path('dashboard/transfers-report/',       admin_transfers_report_view,      name='admin-transfers-report'),
    path('dashboard/transfers-report/export/', export_transfers_report,         name='export-transfers-report'),
